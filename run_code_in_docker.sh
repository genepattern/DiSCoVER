...
docker run --rm -w /job_1234 -v $PWD/job_1234:/job_1234 -v $PWD/data:/temp/data -it genepattern/discover:1.1 python /module/call_discover.py -g "/temp/data/gene_expression.csv" -m False -u False -c "nothing to be seen here"
